...
class AreaConocimientoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['AreaConocimiento'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['AreaConocimiento']))
			$model->attributes=$_GET['AreaConocimiento'];
	...
	{
		$model=AreaConocimiento::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AreaConocimiento $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='area-conocimiento-form')
		{
